/**
 * Lucide-style Icons for HRMS
 * All icons are pure SVG components - no external dependencies
 */
import React from 'react';

// Helper to create icon component
const createIcon = (path, { viewBox = '0 0 24 24', fill = 'none', strokeWidth = 2 } = {}) => {
  return function Icon({ size = 20, className = '', color = 'currentColor', ...props }) {
    return (
      <svg
        width={size}
        height={size}
